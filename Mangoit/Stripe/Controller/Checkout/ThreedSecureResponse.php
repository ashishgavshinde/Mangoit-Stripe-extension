...
class ThreedSecureResponse extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        \Mangoit\Stripe\Model\SubscriptionFactory $subscriptionFactory,
        \Mangoit\Stripe\Model\ChargeFactory $chargeFactory,
        \Magento\Sales\Model\Order\Email\Sender\InvoiceSender $invoiceSender,
        \Magento\Framework\DB\TransactionFactory $transactionFactory,
        \Magento\Framework\Controller\Result\JsonFactory $resultJsonFactory,
        \Mangoit\Stripe\Helper\Config $stripeConfig,
    ...
    {
        $debugOn = $this->stripeConfig->isDebugMode();
        if ($debugOn === true) {
