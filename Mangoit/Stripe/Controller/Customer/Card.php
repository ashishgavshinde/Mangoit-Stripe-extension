...
namespace Mangoit\Stripe\Controller\Customer;
...
class Card extends Action
{
    ...
    public function __construct(
        ...
        \Mangoit\Stripe\Helper\Config $config,
        \Magento\Framework\Controller\Result\JsonFactory $resultJsonFactory,
        DataHelper $dataHelper,
        \Mangoit\Stripe\Model\CustomerFactory $customerFactory,
        \Mangoit\Stripe\Model\StripePaymentMethod $stripePaymentMethod
    ) {
