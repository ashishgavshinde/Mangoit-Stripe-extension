...
class Cron
{
    ...
    public function __construct(
        ...
        \Mangoit\Stripe\Helper\Logger $logger
    ) {
    ...
    public function syncEveryTwoMins()
    {
        ...
        /** @var \Mangoit\Stripe\Model\Subscription $item */
...
//            if (1) {
                ...
                if (isset($plan['currency'])) {
                    ...
                    $currencyCode = $order->getBaseCurrency();
                }

                //the gross amount
//                if (isset($plan['currency'])) {
//                    if (strtoupper($plan['currency']) == 'JPY') {
//                        $grossAmount = ($plan['amount']);
//                    } else {
//                        $grossAmount = ($plan['amount']) / 100;
//                    }
//                } else {
