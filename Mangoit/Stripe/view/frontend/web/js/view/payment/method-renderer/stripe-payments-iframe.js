...
define(
    ...
    function ($,
        ...
        var handler = StripeCheckout.configure({
            key: window.Mangoit.stripe.publishableKey,
            locale: 'auto'
        });
        
        return Component.extend({
            defaults: {
                template: 'Mangoit_Stripe/payment/stripe-payments-iframe',
            ...
            iframePlaceOrder: function () {
                ...
                $.ajax({
                    url: window.Mangoit.stripe.iframeConfigUrl,
                    type: 'GET',
                    async: true,
